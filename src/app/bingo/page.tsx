          ...
          {locations.flatMap((location) =>
            location.assignments.map((assignment, index) => (
              <div
                ...
                className={`flex flex-col items-center justify-center h-16 w-16 font-bold rounded-lg shadow-md cursor-pointer text-center ${
                    ...
                    onPress={() => {
                      ...
                      selectedAssignment.assignment.completed
                        ? markAssignmentIncomplete(
                            selectedAssignment.assignment.locationId,
